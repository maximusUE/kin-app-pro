...
// iOS Status Bar
export function StatusBatteryIcon({ className = 'w-6 h-3' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 25 12" fill="currentColor">
      <rect x="0.5" y="0.5" width="21" height="11" rx="3.5" fill="none" stroke="currentColor" strokeWidth="1" opacity="0.4" />
      <rect x="2" y="2" width="18" height="8" rx="2" fill="currentColor" />
      <path d="M23 4C23.8284 4 24.5 4.67157 24.5 5.5V6.5C24.5 7.32843 23.8284 8 23 8V4Z" fill="currentColor" opacity="0.4" />
    </svg>
  );
}

export function StatusWifiIcon({ className = 'w-4 h-3' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 16 12" fill="currentColor">
      <path d="M8 9.5C9.10457 9.5 10 10.3954 10 11.5C10 11.7761 9.77614 12 9.5 12H6.5C6.22386 12 6 11.7761 6 11.5C6 10.3954 6.89543 9.5 8 9.5Z" />
      <path fillRule="evenodd" clipRule="evenodd" d="M3.75736 6.75736C6.10051 4.41421 9.89949 4.41421 12.2426 6.75736C12.6332 7.14788 13.2663 7.14788 13.6569 6.75736C14.0474 6.36683 14.0474 5.73367 13.6569 5.34315C10.5327 2.21895 5.46734 2.21895 2.34315 5.34315C1.95262 5.73367 1.95262 6.36683 2.34315 6.75736C2.73367 7.14788 3.36684 7.14788 3.75736 6.75736Z" />
      <path fillRule="evenodd" clipRule="evenodd" d="M0.928932 3.92893C4.83418 0.0236893 11.1658 0.0236893 15.0711 3.92893C15.4616 4.31946 15.4616 4.95262 15.0711 5.34315C14.6805 5.73367 14.0474 5.73367 13.6569 5.34315C10.5327 2.21895 5.46734 2.21895 2.34315 5.34315C1.95262 5.73367 1.31946 5.73367 0.928932 5.34315C0.538408 4.95262 0.538408 4.31946 0.928932 3.92893Z" />
    </svg>
  );
}

export function StatusCellularIcon({ className = 'w-4 h-3' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 17 11" fill="currentColor">
...
export function SettingsGearIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
...
export function SlidersFilterIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 13.5V3.75m0 9.75a3 3 0 100 6 3 3 0 000-6zm0 6V20.25m6-16.5v3.75m0 0a3 3 0 100 6 3 3 0 000-6zm0 6V20.25m6-16.5v9.75m0 0a3 3 0 100 6 3 3 0 000-6zm0 6V20.25" />
    </svg>
  );
}
...
// Action Icons
export function AddMoneyIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
...
export function KinCashCircleIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.85">
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.85" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 7.5v9" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 7.5L9.5 12l5.5 4.5" />
    </svg>
  );
}
...
export function BankIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.5m-15 10.5V10.5M3 21h18M4.5 10.5h15" />
    </svg>
...
export function CardOutlineIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-6 3.75h16.5a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5H4.5A2.25 2.25 0 002.25 6.75v10.5A2.25 2.25 0 004.5 21z" />
    </svg>
  );
}
...
export function FourSquaresIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
...
export function PhoneLandlineIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
    </svg>
...
export function GraduationCapIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147L12 14.653l7.74-4.506a.75.75 0 000-1.294L12 4.347 4.26 8.853a.75.75 0 000 1.294z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 12.75v3.424a4.5 4.5 0 003.58 4.412l2.42.484 2.42-.484A4.5 4.5 0 0018 16.174V12.75" />
    </svg>
  );
}

export function HouseRentIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
...
export function HospitalCrossIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5H4.5A2.25 2.25 0 002.25 6.75v10.5A2.25 2.25 0 004.5 19.5z" />
    </svg>
  );
}
...
export function CoffeeCupIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 8.25v2.25a3 3 0 01-3 3h-6a3 3 0 01-3-3V8.25M6 18h12M18 9h1.5a2.25 2.25 0 012.25 2.25v.75a2.25 2.25 0 01-2.25 2.25H18" />
    </svg>
  );
}

export function AirplaneIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
    </svg>
...
// Dock Icons
export function DockHomeIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
    </svg>
...
export function DockCardIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <rect x="3" y="5" width="18" height="14" rx="3" strokeWidth="1.75" />
...
export function DockSendSparkleIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
    </svg>
...
export function DockAnalyticsIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
...
export function DockUserIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
    </svg>
...
export function VaultIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75h6m-6 3h6m-6-6h6m-9-3.75h12A2.25 2.25 0 0120.25 4.5v15A2.25 2.25 0 0118 21.75H6A2.25 2.25 0 013.75 19.5V4.5A2.25 2.25 0 016 2.25z" />
    </svg>
  );
}
...
export function ShareReceiptIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
...
export function RosetteBadgeCheckIcon({ className = 'w-16 h-16' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 48 48" fill="none">
      <path d="M24 4L28.8 8.4L35.2 8.2L37.8 14.1L43.8 16.5L43.5 22.9L47 28.3L44 34L44.5 40.4L38.2 41.8L35 47.4L28.8 45.4L24 49.5L19.2 45.4L13 47.4L9.8 41.8L3.5 40.4L4 34L1 28.3L4.5 22.9L4.2 16.5L10.2 14.1L12.8 8.2L19.2 8.4L24 4Z" fill="url(#rosette-grad)" stroke="#2ED5A4" strokeWidth="1.5" strokeLinejoin="round" />
      <path d="M16 24.5L21.5 30L32 19" stroke="#0E0F1A" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
      <defs>
        <linearGradient id="rosette-grad" x1="1" y1="4" x2="47" y2="49.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#2ED5A4" />
          <stop offset="1" stopColor="#22BC90" />
        </linearGradient>
      </defs>
    </svg>
  );
...
export function TransferSwapIcon({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export function ApplePayIcon({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.37c.65-.79 1.09-1.9 0.97-3.01-.94.04-2.07.63-2.73 1.4-.58.67-1.09 1.76-.95 2.83 1.05.08 2.12-.53 2.71-1.22z" />
    </svg>
  );
}

export function CreditCardGradientIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
...
export function UserPlusIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v6m3-3h-6m-1.5 5.25a6 6 0 00-9 0M10.5 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
  );
}
...
export function QuickLinkIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-3.323l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244"
      />
    </svg>
  );
}

export function BillPaymentDocIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path
        strokeLinecap="round"
...
export function DockWalletIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path
        strokeLinecap="round"
...
export function SendQuickIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
...
export function FingerprintIcon({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0015.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 004.07 9m5.936 8.529a10.024 10.024 0 01-1.921-.76" />
    </svg>
  );
}

export function QrCodeScannerIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5v3m0-3h3m-3 0l3 3m10.5-3h3m0 0v3m0-3l-3 3M3.75 19.5v-3m0 3h3m-3 0l3-3m13.5 3h-3m3 0v-3m0 3l-3-3M9 9h6v6H9V9z" />
    </svg>
  );
}

export function SwapHorizIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
    </svg>
